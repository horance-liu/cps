...
本规范主要由刘光聪(毕诚)编写，并由袁英杰审阅。此外，规范由\ascii{COCK(C++ Optimal Construction Kit)}社区的组员长期维护和持续更新，感谢各位小伙伴们的积极参与。

由于时间的仓促，规范错误再所难免。如果您发现了错误，或者有更好的意见，请第一时间联系\ascii{COCK}的小伙伴，我们将非常感激！
